...
class ExponentialStretch:
    ...
    #The method performs an exponential histogram stretch on the image.
    def stretch(self, input_image):
        ...
        for i in range(len(x)):
            ...
            last = (256 - 1) * (1 - np.exp(-self.gamma*self.sk)) #the intensity value that the current bin should be stretched to
...
if __name__ == "__main__":
    stretcher = ExponentialStretch(gamma=0.5)
    stretcher.stretch("img1.jpeg")
